...
![Point count locations within the Eagle River Flats proposed expansion area](./figures/ERFExpansion.jpg){width=80%}
...
![Left: Recently hatched Lesser Yellowlegs chicks in nest bowl at Ammo Country wetlands. Right: Placemnet of TinyTag data logger probe in the center of a Lesser Yellowlegs nest ](./figures/leye_probe.jpg){width=80%}
...
kable(format="html",
  ...
  as_image(sosc,file="table1.png", width = 4)
...
```{r table2, out.width="60%", eval=TRUE, echo=FALSE, message=FALSE}
...
kable(format="html",
  ...
  as_image(erf.sp,file="table2.png", width = 4)
...
```{r plot1, out.width="90%", eval=TRUE, echo=FALSE, message=FALSE}
...
\caption[Avian taxon detection trends during wetland surveys in 2016, 2017, 2019, and 2020.]{Avian taxon detection trends during wetland surveys in 2016, 2017, 2019, and 2020}

```{r plot4, eval=TRUE, echo=FALSE, message=FALSE}
...
as_image(erf.rich,file="table3.png", width = 4)
```
\par
...
```{r Figure4, out.width="60%", eval=TRUE, echo=FALSE, message=FALSE}
...
```{r appendixa, out.width="60%", eval=TRUE, echo=FALSE, message=FALSE}
...
\caption[Status, number of individuals, and relative occurrence of bird species detected during two breeding season survey periods on lowland wetlands on Joint Base Elmendorf-Richardson, 2020.]{Appendix B. Status, number of individuals, and relative occurrence of bird species detected during two breeding season survey periods on lowland wetlands on Joint Base Elmendorf-Richardson, 2020.}
```{r appendixb, out.width="60%", eval=TRUE, echo=FALSE, message=FALSE}
...
kable(format="html",
 ...
 as_image(results.table,file="appendixb.png", width = 4)
```
